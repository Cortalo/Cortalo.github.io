...
Ex1: $$\lim_{n\to\infty}a_n = \lim_{n\to\infty}b_n = L$$, and $$a_n \le c_n \le b_n$$, then $$\lim_{n\to\infty}c_n = L$$.
...
$$
\begin{align}
a_n &= \binom{n}{0} + \binom{n}{1}\dfrac{1}{n} + \binom{n}{2}\dfrac{1}{n^2} + \dots + \binom{n}{n}\dfrac{1}{n^2}\\
...
$$
\liminf_{n\to\infty} a_n := \lim_{n\to\infty} l_n
$$

Ex4: $$a_n$$ converges $$\iff$$ $$\limsup_{n\to\infty} a_n = \liminf_{n\to\infty} a_n$$, and if it is the case, $$\lim_{n\to\infty}a_n = \limsup_{n\to\infty} a_n = \limsup_{n\to\infty} a_n$$
...
$$
\forall \epsilon > 0\, \exists N \in\mathbb{N}\, [n \ge N \implies A - \varepsilon \le l_n \le a_n \le u_n \le A + \varepsilon ]
$$
